...
const features: CardItem[] = [
  {
    ...
    desc: "Precise fat, SNF, protein, and density testing for reliable results.",
    icon: HiBeaker,
  },
  {
    title: "Fast Testing Results",
    desc: "Generate milk quality reports within seconds.",
    icon: HiLightningBolt,
  },
  {
    title: "Easy To Operate",
    desc: "Simple and user-friendly interface for smooth operation.",
    icon: HiCog,
  },
  {
    title: "Durable Build Quality",
    desc: "Built for continuous industrial and commercial dairy usage.",
    icon: HiShieldCheck,
  },
];
...
const benefits: CardItem[] = [
  {
    ...
    desc: "Maintain consistent milk quality and testing standards.",
    icon: HiTrendingUp,
  },
  {
    title: "Saves Time",
    desc: "Quick testing process improves dairy workflow efficiency.",
    icon: HiClock,
  },
  {
    title: "Cost Efficient",
    desc: "Reduces losses caused by inaccurate milk testing results.",
    icon: HiCurrencyRupee,
  },
  {
    title: "Industry Standard Compliance",
    desc: "Supports dairy quality testing and compliance requirements.",
    icon: HiChartBar,
  },
];
...
export default function MilkAnalyzerMachinesShowcase() {
  return (
    <div
      className="
