              ...
              },
             {
              ...
              <li key={link.name}>
                <Link
                  ...
                  className="group flex min-h-3 items-center gap-2
px-2 py-2 transition hover:text-amber-600"
            ...
            {[
              ...
              >
                ...
                <Link
                  ...
                  className="inline-flex min-h-3 items-center py-2 transition hover:text-amber-600"
                >
                  {item.name}
                </Link>
              </li>
  ...
  className="inline-flex min-h-11 items-center py-2 transition hover:text-amber-700"
>
                +91 73750 82341
              </a>
            </div>
      ...
      <div className="relative border-t border-amber-200 bg-amber-100 px-2 py-1 text-[10px] text-slate-700">
        <div className="mx-auto flex flex-col items-center justify-between gap-1 md:flex-row">
          ...
          <Link
            ...
            className="flex min-h-11 items-center gap-2 px-2 py-2 transition hover:text-amber-700"
          >
            <span>Made with</span>
