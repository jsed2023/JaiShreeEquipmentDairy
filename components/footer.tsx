  ...
  <div className="mt-3 space-y-4 text-sm">
    ...
    <div>
      <a
        href="mailto:choudharydairy@outlook.com"
        aria-label="Email Jai Shree Equipment Dairy"
        className="flex min-h-12 items-center gap-3 rounded-md px-2 py-2 text-slate-600 transition-all duration-200 hover:bg-amber-50 hover:text-amber-700 focus:outline-none focus:ring-2 focus:ring-amb>
  </div>
</div>
    </footer>
  );
