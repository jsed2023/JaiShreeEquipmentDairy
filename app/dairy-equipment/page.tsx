...
export default function DairyEquipmentsPage() {
  return (
   ...
   <section>
          ...
          border border-stone-200 dark:border-zinc-700 rounded-lg p-4 max-h-100 space-y-3
...
<section className="py-6">
  ...
  />
         ...
         <div className="p-5">
          <h3 className="text-xl font-bold text-center text-zinc-90 dark:text-white line-clamp-2
        bg-clip-text text-transparent animate-title-gradient">
            {product.name}
          </h3>
