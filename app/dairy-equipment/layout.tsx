...
export const metadata: Metadata = {
  ...
  description:
    "Explore high-quality dairy equipment including cream separators machines, paras milk cream separator machine, dairy automation systems supplied by Jai Shree Equipment Dairy.",
  ...
  openGraph: {
    ...
    description:
      "Buy reliable dairy equipment such as milk cream separators from Jai Shree Equipment Dairy.",
