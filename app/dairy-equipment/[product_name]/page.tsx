...
export default function Product({
  ...
  const currentIndex = allDairyEquipments.findIndex(
    (item) => item.url.toLowerCase() === productName.toLowerCase()
  );

  const prevProduct =
    currentIndex > 0 ? allDairyEquipments[currentIndex - 1] : null;

  const nextProduct =
    currentIndex < allDairyEquipments.length - 1
      ? allDairyEquipments[currentIndex + 1]
      : null;
      ...
      >
        ...
        <div className="grid lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-5">
            ...
            <h2 className="font-bold underline tracking-widest mt-6">
              Features:
            </h2>
        ...
        {/* FIXED PRICE */}
        <p
          className="inline-flex items-center justify-center gap-3 px-5 py-2.5
          ...
          <table className="w-full border">
            ...
            <tbody>
              {product.features.map((item, index) => (
                <tr key={`${product.id}-spec-${item.id}-${index}`}>
                  <td className="border p-3">{item.key}</td>
      ...
      <div className="mt-10 rounded-xl bg-linear-to-r from-blue-50 via-purple-50 to-cyan-50 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 p-6 md:p-8 border border-gray-200 dark:border-zinc-700">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p>
              {product.name} is designed to improve dairy operations by
              providing reliable performance, accurate results, and easy
              operation.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              maintenance, and is suitable for dairy farms, milk collection
              centres, and cooperative societies.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Yes, {product.name} is ideal for commercial dairy applications
              and can be used in milk collection centres, dairy plants, and
              private dairies.
            </p>
          </div>
