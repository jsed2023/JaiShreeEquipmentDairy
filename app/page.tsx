...
export default function Home() {
  ...
  return (  
   <>
{/* ================= HERO BANNER ================= */}
<section id="hero-banner-section" className="mt-4 w-full">
  <Image
  ...
  <strong>
    Milk Fat Testing Machine, Milk Analyzer Machines, Ekomilk Ultra, Milk Collection Units, Advance Milk Analyzer Max,
...
<section
  id="krei-logo-strip"
  className="bg-[rgb(244,244,245)] py-8 dark:bg-[#1f1f22]"
>
  ...
  <span className="animate-title-gradient rounded-full bg-green-600 px-4 py-1 text-sm font-semibold text-transparent shadow-md md:text-base">
    ...
    {/* Trust Icons */}
    <div className="animate-title-gradient mt-4 flex flex-wrap justify-center gap-8 bg-clip-text text-transparent">
      {/* Genuine Products */}
