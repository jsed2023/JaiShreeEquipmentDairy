    ...
    <main className="min-h-screen bg-white text-black">
      ...
      <section className="relative overflow-hidden border-b border-gray-200 bg-linear-to-br from-cyan-50 via-white to-blue-50">
        <div className="mx-auto max-w-6xl px-6 py-16 md:py-24">
          ...
          {/* Blog Image */}
   {/* Blog Image */}
<div className="mx-auto mt-14 w-full max-w-5xl rounded-3xl border border-gray-200 bg-white p-4 shadow-xl md:p-6">
  <div className="relative h-80 w-full sm:h-100 md:h-120">
    <Image
      src={blog.image}
      alt={blog.alt}
      fill
      sizes="(max-width: 640px) 100vw, (max-width: 768px) 90vw, 1024px"
      ...
      <section className="mx-auto max-w-4xl px-6 py-16 md:py-20">
        ...
        <div className="mt-14 rounded-3xl border border-cyan-200 bg-cyan-50 p-8 text-center shadow-md md:p-12">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg leading-8 text-gray-600">
            Contact Jai Shree Equipment Dairy for premium dairy machinery,
            milk analyzers, milking machines, and dairy equipment solutions.
          </p>
