  ...
  return (
    <div className="p-5 max-w-5xl mx-auto">
      ...
      <link rel="preload" as="image" href={getCldUrl(images[0].src, 800)} />
            ...
            <div className="flex w-fit mx-auto items-center justify-center px-4 py-1.5 mb-4 
    rounded-full font-semibold
    bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-cyan-500/10
    border border-purple-400/30 backdrop-blur-sm">

    <h1 className="text-lg md:text-xl font-bold text-center underline bg-clip-text text-transparent animate-title-gradient">
      Product Gallery
    </h1>
